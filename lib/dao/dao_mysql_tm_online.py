...
class DaoMysqlTmOnline:
    def __init__(self):
        self.host = Conf.get_value_str("conf/server.conf", "mysql_tm_online", "host")
        self.port = int(Conf.get_value_str("conf/server.conf", "mysql_tm_online", "port"))
        self.user = Conf.get_value_str("conf/server.conf", "mysql_tm_online", "user")
        self.passwd = Conf.get_value_str("conf/server.conf", "mysql_tm_online", "passwd")
        self.db = Conf.get_value_str("conf/server.conf", "mysql_tm_online", "db")
